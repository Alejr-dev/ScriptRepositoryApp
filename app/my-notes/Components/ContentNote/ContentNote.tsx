  ...
  return (
    <div className="flex justify-between    gap-8 mb-4 ">
      <div className="flex   gap-2 w-full  ">
        <TitleOutlinedIcon
          sx={{ fontSize: 19 }}
          className={`${onFocus ? "text-[#0083bb]" : "text-slate-400"} mt-[4px]`}
        />
        <textarea
          ref={textRef}
          ...
          className={`font-bold text-xl outline-none resize-none h-auto overflow-hidden w-full ${
            darkMode[1].isSelected ? "bg-slate-800 text-white" : "bg-white text-slate-500"
          }`}
...
function NoteTags({
  ...
  return (
    <div className="flex text-[13px] items-center gap-2">
      <StyleOutlinedIcon
        sx={{ fontSize: 19 }}
        className={`${hovered ? "text-[#0083bb]" : "text-slate-400"}`}
      />
      <div
  ...
  return (
    <div className="flex gap-2  text-[12px]  mt-8">
      <DescriptionOutlinedIcon
        sx={{ fontSize: 18 }}
        className={` mt-[9px] ${isHovered ? "text-[#0083bb]" : "text-slate-400"}`}
      />
      ...
      <textarea
        ...
        className={`text-sm outline-none border ${isHovered ? "border-[#0083bb]" : ""} rounded-lg p-2 w-full ${
          darkMode[1].isSelected ? "bg-slate-800 text-white" : "bg-white text-slate-500"
        }`}
  ...
  return (
    <div className="flex gap-2  text-[12px] text-slate-400 mt-8 relative">
      ...
      <div
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className={`${isHovered ? "border-[#0083bb]" : ""} border rounded-lg p-3 pt-16 w-full relative`}
      >
