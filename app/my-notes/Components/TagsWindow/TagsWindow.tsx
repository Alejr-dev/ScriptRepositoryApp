    ...
    <div className="flex gap-5 items-center justify-between mt-11 relative">
      ...
      >
        ...
        <input
          ...
          className={`bg-transparent outline-none w-full font-light placeholder-gray-400 dark:placeholder-gray-500 border-b-2 ${
            darkMode[1].isSelected ? "text-gray-200" : "text-gray-800"
          } ${searchQuery ? "border-b-[#0083bb]" : "border-b-transparent"}`}
          onChange={(e) => setSearchQuery(e.target.value)}
        />
      </div>
      <button
        onClick={() => setOpenNewTagsWindow(true)}
        className="bg-[#0083bb] ml-2 p-[10px] flex w-[15%] text-sm rounded-md text-white items-center justify-center max-lg:w-[25%]"
      >
  ...
  return (
    ...
    >
      <div className="flex gap-3 items-center">
        <div className="w-2 h-2 bg-[#0083bb] rounded-full"></div>
