  ...
  return (
    ...
    >
        ...
        {isLoading ? (
          ...
          >
            {allTags.map((tag, index) => (
              <SwiperSlide
                key={index}
                className={`${tagsSelected[index] ? "bg-[#0083bb] text-white" : `${darkMode[1].isSelected ? "bg-slate-800" : "bg-white"} hover:text-[#0083bb]   text-gray-400`}   p-1 rounded-md  `}
      ...
      <button
        ...
        className="bg-[#0083bb] p-1 rounded-md px-3 flex gap-1 items-center text-white text-sm"
      >
