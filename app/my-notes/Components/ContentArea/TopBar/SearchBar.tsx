...
function SearchBar() {
  ...
  return (
    ...
    >
      <SearchIcon className="text-[#0083bb]" sx={{ fontsize: 13 }} />
      <input
  ...
  function AddSnippetButton() {
    ...
    return (
      ...
      text-[13px] text-white top-[6px] right-[6px] items-center cursor-pointer select-none ${openContentNote ? "bg-[#0083bb]/50" : "bg-[#0083bb]"}`}
      >
